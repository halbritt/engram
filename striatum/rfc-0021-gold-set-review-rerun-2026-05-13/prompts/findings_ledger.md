...
Read the three independent reviews under `docs/reviews/rfc0021-rerun-2026-05-13/`:
...
Write to `docs/reviews/rfc0021-rerun-2026-05-13/RFC_0021_GOLD_SET_FINDINGS_LEDGER.md`:
