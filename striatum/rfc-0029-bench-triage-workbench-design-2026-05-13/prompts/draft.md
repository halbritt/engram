...
review artifacts as authoritative evidence. Treat existing RFC text as draft
input only. If your runtime supports sub-agents, use the maximum useful number
of sub-agents for independent design, privacy, CLI, and UX checks, with
disjoint document ownership.
