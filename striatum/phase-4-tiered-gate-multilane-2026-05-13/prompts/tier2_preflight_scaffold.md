...
Use `docs/operations/phase4-build/tiered-gate-multilane-2026-05-13/TIER1_NONHUMAN_REPORT.md` as
...
Write `docs/operations/phase4-build/tiered-gate-multilane-2026-05-13/TIER2_PREFLIGHT_SCAFFOLD.md`.
Include:
