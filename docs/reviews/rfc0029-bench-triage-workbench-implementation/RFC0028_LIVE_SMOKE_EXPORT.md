...
| `0726c93f-2376-4e47-a273-eb7582e253c9` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `8` | `0` | `undecided` |  |
| `1d13d0d1-35c5-4e92-81fd-2b341b8d6e31` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `1` | `0` | `undecided` |  |
| `2a419384-8a05-4a87-ab26-fa21ec5e9fbe` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `1` | `0` | `undecided` |  |
| `431fd7be-5cd8-4686-b4bf-d976cc31219e` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `2` | `0` | `undecided` |  |
| `86d97778-c666-4c75-a569-4ed7894a6738` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `3` | `0` | `undecided` |  |
| `8d98e0a4-2ad3-4464-888c-4f0d5fa0c8b2` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `7` | `0` | `undecided` |  |
| `963bc3fb-716e-4f3d-9be1-a9b84bce532c` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `2` | `0` | `undecided` |  |
| `a7de1e53-ef68-4e78-a3f2-ca5238486481` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `2` | `0` | `undecided` |  |
| `ae053e3c-b55f-4302-a98f-c21033f50e57` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `21` | `0` | `undecided` |  |
| `dc3246f2-09b6-4275-be61-11f9d5e2f7ef` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `2` | `0` | `undecided` |  |
| `ebea134c-146c-45a5-bfea-650eebb81569` | `candidate_zero` | `zeroed, count_changed, predicate_mix_changed` | `5` | `0` | `undecided` |  |
