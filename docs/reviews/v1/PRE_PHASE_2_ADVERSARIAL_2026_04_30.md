...
*   **Decision or document touched:** `prompts/phase_2_segments_embeddings.md` (Schema migration), `DECISION_LOG.md` (D027).
...
*   **Decision or document touched:** `prompts/phase_2_segments_embeddings.md` (Schema migration).
...
*   **Decision or document touched:** `prompts/phase_2_segments_embeddings.md` (Segmenter contract).
...
*   **Decision or document touched:** `prompts/phase_2_segments_embeddings.md` (Docs section).
...
*   **Decision or document touched:** `prompts/phase_2_segments_embeddings.md`
*   **Proposed doc / schema / prompt delta:** N/A (Deferred)
